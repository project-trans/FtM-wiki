...
测量 血清睾酮，直至水平达到正常生理男性范围

1. 对于 {{< abbr TE >}} / {{< abbr TC >}}（该两种睾酮半衰期几乎相同）注射，应在两次注射之间的中点测量睾酮水平。

   目标水平为指派男性范围 14 ~ 25.4 nmol/L（≈ 400 ~ 732 ng/dL）。

   另一方法是测量峰值和谷值水平以确保水平保 持在正常男性范围内。

1. 对于注射 {{< abbr TU >}}，应在下一次注射前测量睾酮水平。

   如果水平小于正常男性值下界 14 nmol/L（≈ 400 ng/dL），与医生讨论调整给药间隔。

1. 对于 [透皮睾酮]({{< ref "androgen#dosage-form" >}}) 或 [口服睾酮]({{< ref "testosterone#oral" >}})，从开始每日使用开始的一周后，于当日给药至少 2 小时后测量睾酮水平。
